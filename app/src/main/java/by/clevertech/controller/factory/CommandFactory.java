...
public class CommandFactory {
    ...
    private CommandFactory() {
        ...
        commands.put("file", new FileCommand(ServiceFactory.INSTANCE.getService(CheckService.class))); // FIXME
        commands.put("cli", new CliCommand(ServiceFactory.INSTANCE.getService(CheckService.class))); // FIXME
    }
